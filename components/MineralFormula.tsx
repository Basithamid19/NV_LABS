...
export const MineralFormula: React.FC = () => {
  return (
    <section className="bg-parchment py-section-sm md:py-section-md relative overflow-hidden">
      {/* Subtle green ambient glow on the right side */}
      ...
      <div className="container mx-auto px-6 max-w-6xl relative z-10">
        <div className="max-w-5xl overflow-hidden md:overflow-visible">
          {/* Heading popping in from the Left */}
          <div className="scroll-reveal scroll-reveal-left mb-8">
            <h2 className="text-3xl md:text-6xl font-serif leading-[1.1] tracking-tight text-charcoal">
              <span className="font-bold">Fuel</span> your day with nature’s powerful & complete mineral formula.
            </h2>
          </div>
          
          {/* Body popping in from the Right */}
          ...
          {/* Grey accent bar with a standard reveal */}
